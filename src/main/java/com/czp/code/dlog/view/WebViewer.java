 ...
 * @date: 2016年1月23日 http://www.eclipse.org/jetty/documentation/current/jetty-websocket -server-api.html
 */
public class WebViewer extends WebSocketServlet implements IMessageHandler, WebSocketListener, Runnable {
    ...
    public void onWebSocketConnect(Session session) {
        ...
        DaemonTimer.getInstance().addTask(this);
    }
